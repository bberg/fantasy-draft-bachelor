...
s_omni.linkInternalFilters = "javascript:watchabc.go.com,abc.go.com,abc.com";
s_omni.linkLeaveQueryString = true;
s_omni.linkTrackVars="prop1,prop2,prop3,prop4,prop5,prop6,prop7,prop8,prop10,prop21,prop25,prop26,prop27,prop31,prop36,prop52,prop56,prop72,eVar1,eVar2,eVar3,eVar4,eVar5,eVar6,eVar7,eVar8,eVar10,eVar21,eVar25,eVar26,eVar27,eVar31,eVar36,eVar52,eVar56,eVar72";
...
function s_omni_doPlugins(s_omni) {
	...
	if (!s_omni.campaign) {
		s_omni.campaign = s_omni.getQueryParam('cid,cmp,rfr,refcd,tsacr', ':');
	}
	...
	s_omni.eVar2 = s_omni.prop2;
	s_omni.prop7 = s_omni.c_r('datg_aff');
	s_omni.eVar7 = s_omni.prop7;
	

	/* Plugin: detectRIA v0.1 */
	/*s_omni.detectRIA('s_ria','prop12','','20','','1');*/
}
...
/************* Callback Function **************/
 if(typeof runOmni=="function"){runOmni();}
